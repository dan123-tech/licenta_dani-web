...
const PLANS = [
  {
    ...
    highlight: false,
    description: "A lightweight sandbox to try FleetShare before you commit.",
...
const FAQS = [
  {
    ...
    a: "Yes. The Free plan has no time limit — it’s meant as a lightweight sandbox for up to 2 vehicles.",
  },
  {
